...
abstract class Action
{
    ...
    protected function validateData($data, array $rules, array $messages = []): array
    {
        ...
        if ($validator->fails()) {
            throw new ValidationErrorException(errors: $validator->errors());
        }
     ...
     */
    protected function validationErrorResult(array $errors, string $message = 'Validation error.'): ActionResult
    {
     ...
     */
    protected function successResult(mixed $data = null, string $message = 'Operation successful.', int $statusCode = 200): ActionResult
    {
     ...
     */
    protected function errorResult(string $message = 'Operation failed.', array $errors = [], int $statusCode = 400): ActionResult
    {
